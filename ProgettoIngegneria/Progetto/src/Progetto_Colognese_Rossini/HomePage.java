...
public class HomePage extends JFrame {
	...
	private ProdottoPage prodottoPage = new ProdottoPage(0, this);
	...
	private static final JComboBox<String> filtraPerComboBox = new JComboBox<String>(
			new String[] { "        --- Seleziona ---", "Genere", "Artista", "Partecipante", "Prezzo crescente",
					"Prezzo decrescente" });
